...
const qa_数学B_数列 = [
  ...
  ["a_1=1,\\quad a_{n+1}=\\dfrac{a_n}{2+a_n}\n\\text{のとき }a_n=","\\dfrac1{a_{n+1}}=\\dfrac2{a_n}+1\n\\therefore \\dfrac1{a_{n+1}}+1=2\\left(\\dfrac1{a_n}+1\\right)=2^{n+1}\n\\therefore a_n=\\dfrac1{2^n-1}"],
